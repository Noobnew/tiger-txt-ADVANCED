...
bot = Client("bot",
             bot_token= "6887284756:AAE-g2qKwDkuRBqz_G3qnxvRcDO8KV3o-JY",
             api_id=26702812,
             api_hash= "67af78a19eac1570697ccc64e670bd11")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002023671255, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002023671255)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
